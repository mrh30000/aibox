...
export const mcptutorialsSeed: SeedMCPTutorial[] = [
  {
    ...
    summary:
      'AIbase要为你介绍的就是一款炙手可热的 MCP 应用 ——HowToCook-MCP Server。这款应用将 AI 技术与美食制作巧妙结合...',
    imageUrl:
      'https://img-1255512983.cos.ap-guangzhou.myqcloud.com/aibase/info/c19e075a204e4a86acdc525594768463.jpg',
  ...
  },
  {
    ...
    summary:
      'OpenMemory MCP（Model Context Protocol）正式推出，为AI工具提供统一的本地记忆共享解决方案...',
    imageUrl:
      'https://img-1255512983.cos.ap-guangzhou.myqcloud.com/aibase/info/87f812e309254372859a1538d0bdb37e.jpg',
  ...
  },
  {
    ...
    summary:
      '纳米AI的智能体为英语学习者和教育者带来了革命性的工具。本教程将详细指导您如何利用纳米AI的智能体...',
    imageUrl:
      'https://img-1255512983.cos.ap-guangzhou.myqcloud.com/aibase/info/09b25ed1e8154f3488ed36aae87946df.jpg',
  ...
  },
  {
    ...
    summary:
      'Bing MCP 不仅是一个搜索工具，它更像是你的私人智能助手。它通过深度学习与中文语义的结合...',
    imageUrl:
      'https://img-1255512983.cos.ap-guangzhou.myqcloud.com/aibase/info/23a4e3f9914a477998261a16009b655c.png',
