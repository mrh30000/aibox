...
export class AppService {
  ...
  getProjectsPageData(category?: string, sort?: string, time?: string, page: number = 1, limit: number = 5) {
    ...
    const allMockProjects = [
      ...
      { id: 'p6', avatarLetter: 'A', name: 'Another TTS Project', description: 'Another great TTS tool', tags: ['Audio', 'TTS'], stars: 22, growth: '+2', forks: 4, categoryId: 'tts', categoryName: 'TTS 语音合成', createdAt: new Date('2024-05-01T12:00:00Z'), updatedAt: new Date('2024-06-03T12:00:00Z') },
      { id: 'p7', avatarLetter: 'D', name: 'DeepSeek Analyzer', description: 'Analyze data with DeepSeek tech', tags: ['Python', 'DeepSeek'], stars: 30, growth: '+10', forks: 7, categoryId: 'deepseek', categoryName: 'Deepseek 相关项目', createdAt: new Date('2024-05-05T10:00:00Z'), updatedAt: new Date('2024-06-01T14:00:00Z') },
    ];
