...
export const mcpservicesSeed: SeedMCPServce[] = [
  {
    ...
    description:
      'Framelink Figma MCP Server是一个为AI编程工具（如Cursor）提供Figma设计数据访问的服务器...',
    ...
    imageUrl:
      'https://img-1255512983.cos.ap-guangzhou.myqcloud.com/aibase/head/842883.jpg',
  ...
  },
  {
    ...
    imageUrl:
      'https://img-1255512983.cos.ap-guangzhou.myqcloud.com/aibase/head/9121162.jpg',
    tags: ['开发效率工具', '智能搜索'],
  ...
  },
  {
    ...
    description:
      'Firecrawl MCP Server是一个集成Firecrawl网页抓取能力的模型上下文协议服务器...',
    languageOrTech: 'TypeScript',
    ...
    imageUrl:
      'https://img-1255512983.cos.ap-guangzhou.myqcloud.com/aibase/head/135057108.jpg',
    tags: ['开发效率工具', '数据管理'],
  ...
  },
  {
    ...
    description:
      'MiniMax Model Context Protocol (MCP) 是一个官方服务器，支持与强大的文本转语音、视频/图像生成API交互...',
    languageOrTech: 'Python',
    ...
    imageUrl:
      'https://img-1255512983.cos.ap-guangzhou.myqcloud.com/aibase/head/194880281.jpg',
    tags: ['图像与视频处理'],
  ...
  },
  {
    name: 'Notte Browser',
    description:
      'Notte是一个开源的全栈网络AI代理框架，提供浏览器会话、自动化LLM驱动的代理...',
    ...
    imageUrl:
      'https://img-1255512983.cos.ap-guangzhou.myqcloud.com/aibase/head/183074172.jpg',
    tags: ['浏览器自动化', '聊天机器人'],
  ...
  // Add 15-20 more based on the provided website text...
  {
    name: 'Context7',
    description:
      'Context7 MCP是一个为AI编程助手提供实时、版本特定文档和代码示例的服务...',
    languageOrTech: 'TypeScript',
    ...
    imageUrl:
      'https://img-1255512983.cos.ap-guangzhou.myqcloud.com/aibase/head/74989412.jpg',
    tags: ['开发效率工具', '聊天机器人'],
  ...
  },
  {
    ...
    imageUrl:
      'https://img-1255512983.cos.ap-guangzhou.myqcloud.com/aibase/head/204146226.jpg',
  ...
  },
  {
    name: 'Exa Web Search',
    description:
      'Exa MCP Server是一个为AI助手（如Claude）提供网络搜索功能的服务器...',
    languageOrTech: 'TypeScript',
    ...
    imageUrl:
      'https://img-1255512983.cos.ap-guangzhou.myqcloud.com/aibase/head/77906174.jpg',
    tags: ['智能搜索', '数据管理'],
  ...
  },
  {
    ...
    imageUrl:
      'https://img-1255512983.cos.ap-guangzhou.myqcloud.com/aibase/head/10337030.jpg',
    tags: ['浏览器自动化'],
